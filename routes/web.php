...
//     Route::post('/checkLoanNo', [LoanController::class, 'checkLoanNo'])->name('checkLoanNo');
//     Route::post('/checkPernoteNo', [LoanController::class, 'checkPernoteNo'])->name('checkPernoteNo');
