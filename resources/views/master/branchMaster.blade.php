        ...
        <div class="col-12">
            <div class="card page_headings cards">
                <div class="card-body py-2">
                    <h4 class="py-2"><span class="text-muted fw-light">Masters / Loan Module / </span> Branch Master </h4>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-3 col-sm-4 col-6 ">
                            ...
                            <input type="date" value="{{ Session::get('currentdate') }}" name="registrationDate"
    ...
    var options = [{
        ...
        },
        {
            ...
            render: function(data, type, full, meta) {
                ...
                var menu =
                    `<div style="display: flex;justify-content: space-evenly; align-items: center;"><a href="javascript:void(0);" onclick="editBranchSetup('` + full.id + `','` +
                    full.type + `','` + full.name + `','` + full.registrationNo + `','` + full
...
function editBranchSetup(id, type, name, registrationNo, registrationDate, stateId, districtId,
    ...
    var districtSelect = $('#basicModal').find('select[name="districtId"]');
    ...
    var villageSelect = $('#basicModal').find('select[name="villageId"]');
    villageSelect.val(villageId).trigger('change');
