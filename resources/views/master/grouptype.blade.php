        ...
        <div class="col-sm-12">
            <div class="card page_headings mb-4">
                <div class="card-body py-2">
                    <h4 class="py-2"><span class="text-muted fw-light">Dashboard /</span> Group Type</h4>
                </div>
            </div>
            <div class="card card-action mb-5">
                <div class="card-header">
                    <div class="card-action-title">Group Type</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="groupMaster" action="{{ route('masterupdate') }}" method="post">
                {{ csrf_field() }}
                <input type="hidden" name="actiontype" value="grouptype" />
...
@push('script')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "{{ url('statement/fetch') }}/grouptypemaster";
            var onDraw = function () {
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        menu += `<a onclick="deleteItem('` + full.id +
                            `' ,'deleteGroupType')" href="javascript:void(0);" ><i class="ti ti-trash me-1"></i></a >`;
                        return menu;
                    }
                },
            ];
        ...
        function editGroupTypeMasterSetup(id, name, status) {
            ...
            // $('#basicModal').find('[name="status"]').select21().val(status).trigger('change');
