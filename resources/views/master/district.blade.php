    ...
    <div class="row">
        <div class="col-12 ">
            <div class="card page_headings cards">
                ...
                <h4 class="py-2"><span class="text-muted fw-light">Masters / Address Module / </span> District</h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 cards">
            <div class="card">
                <div class="card-body py-3">
                    <div class="card-action-title">District</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1"> <span class="msg">Add</span> District </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="stateMaster" action="{{route('masterupdate')}}" method="post">
                {{ csrf_field() }}
                <input type="hidden" name="actiontype" value="districts" />
                ...
                <div class="modal-body">
                    <div class="row row-gap-2">
                        ...
                        <div class="col-lg-4 col-sm-4 col-6 py-2 inputesPaddingReport ecommerce-select2-dropdown">
                            ...
                            <select name="stateId" id="status-org" class="select21 form-select formInputsSelectReport" data-placeholder="Active">
                        ...
                        <div class="col-lg-4 col-sm-4 col-6 py-2 inputesPaddingReport">
                            <label for="districname" class="form-label">District Name</label>
...
$(document).ready(function() {
    ...
    var url = "{{url('statement/fetch')}}/districtmaster";
    var onDraw = function() {
        ...
        },
        {
            ...
            render: function(data, type, full, meta) {
                ...
                menu += `<a onclick="deleteItem('` + full.id +
                    `', 'deleteDistrict')" href="javascript:void(0);" ><i class='fa-solid fa-trash iconsColorCustom'></i></a > </div>`;
...
function capitalizeFirstName() {
    var nameInput = $('#district [name="name"]');
