                        ...
                        <div id="personal-info" class="content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="select21" id="country">
                                        <option label=" "></option>
                                        <option>UK</option>
                                        <option>USA</option>
                                        <option>Spain</option>
                        ...
                        <div id="personal-info-validation" class="content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="select21" id="formValidationCountry" name="formValidationCountry">
                                        <option label=" "></option>
                                        <option>UK</option>
                                        <option>USA</option>
                                        <option>Spain</option>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <span class="input-group-text cursor-pointer" id="password2-vertical"><i class="ti ti-eye-off"></i></span>
                                    </div>
                                </div>
                                <div class="col-sm-6 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <span class="input-group-text cursor-pointer" id="confirm-password-vertical2"><i class="ti ti-eye-off"></i></span>
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-between">
                                    <button class="btn btn-label-secondary btn-prev" disabled>
                        ...
                        <div id="personal-info-1" class="content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="select21" id="country-vertical">
                                        <option label=" "></option>
                                        <option>UK</option>
                                        <option>USA</option>
                                        <option>Spain</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="selectpicker w-auto" id="language-vertical" data-style="btn-transparent" data-icon-base="ti" data-tick-icon="ti-check text-white" multiple>
                                        <option>English</option>
                                        <option>French</option>
                                        <option>Spanish</option>
                                    </select>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <span class="input-group-text cursor-pointer" id="confirm-password-modern2"><i class="ti ti-eye-off"></i></span>
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-between">
                                    <button class="btn btn-label-secondary btn-prev" disabled>
                        ...
                        <div id="personal-info-modern" class="content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="select21" id="country-modern">
                                        <option label=" "></option>
                                        <option>UK</option>
                                        <option>USA</option>
                                        <option>Spain</option>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <span class="input-group-text cursor-pointer" id="password2-modern-vertical"><i class="ti ti-eye-off"></i></span>
                                    </div>
                                </div>
                                <div class="col-sm-6 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <span class="input-group-text cursor-pointer" id="confirm-password-modern-vertical2"><i class="ti ti-eye-off"></i></span>
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-between">
                                    <button class="btn btn-label-secondary btn-prev" disabled>
                        ...
                        <div id="personal-info-modern-vertical" class="content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="select21" id="country-modern-vertical">
                                        <option label=" "></option>
                                        <option>UK</option>
                                        <option>USA</option>
                                        <option>Spain</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="selectpicker w-auto" id="language-modern-vertical" data-style="btn-transparent" data-icon-base="ti" data-tick-icon="ti-check text-white" multiple>
                                        <option>English</option>
                                        <option>French</option>
                                        <option>Spanish</option>
                                    </select>
