...
<div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card-body py-2">
            <div class="row justify-content-between">
                <div class="col-lg-10 col-8 pe-0 misPrintMainHeading">
                    <h4 class="py-2"><span class="text-muted fw-light">Reports / Fixed Deposit / </span> Print</h4>
                </div>
    ...
    <section class="section">
        <div id="printDiv" class="card pt-3 pb-4" style="background-color: white !important;">
                    ...
                    <div class="col-12">
                        <div class="table-responsive mx-2">
                            <table class="table text-center table-bordered">
                                ...
                                <tbody id="data-container" style="background-color: white !important;">
                                    <!-- <tr>
