    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card page_headings cards mb-4">
            <div class="card-body py-2">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="py-2"><span class="text-muted fw-light">Reports / </span>Security On Commission Deposit
                            List</h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form action="javascript:void(0)" id="interestcalculationForm" name="interestcalculationForm">
                            ...
                            <div class="row gap-0">
                                ...
                                <div class="col-md-2 col-sm-4 mt-4 col-6 py-3 saving_column inputesPaddingReport"
                                id="paidbutton" style="display: none;">
                                <button type="submit"
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr style="background-color: #7367f0 !important;">
                                <td colspan="3" style="color: white !important;">Grand Total</td>
                                <td id="totalamount" style="color: white !important;">0</td>
                                <td id="totalinterest" style="color: white !important;">0</td>
                                <td id="total" style="color: white !important;">0</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
@push('script')
    <script>
        ...
        function getineterestcalculations() {
            ...
            $.ajax({
                url: "{{ route('getsecurityoncomminterestcaluclation') }}",
                type: 'post',
                data: data,
                headers: {
                    ...
                    if (res.status === 'success') {
                        ...
                        if (balances && balances.length > 0) {
                            balances.forEach((data) => {
                                let openingbalance = parseFloat(data.opening_balance) ? parseFloat(data.opening_balance) : parseFloat(data.last_balance);
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#interestcalculationForm', function(event) {
                ...
                if ($(this).valid()) {
                    ...
                    $.ajax({
                        url: "{{ route('paidsecurityoncomminterest') }}",
                        type: 'POST',
                        data: formData,
                        headers: {
            ...
            $(document).on('click', '#deletebutton', function(event) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            url: "{{ route('deletepaidsecuritycomminterest') }}",
                            type: 'post',
                            data: {
                                paid_date: paid_date,
