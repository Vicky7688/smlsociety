                    ...
                    <div class="card-body">
                        <form action="javascript:void(0)" id="formData" name="formData">
                            <div class="row">
                                ...
                                <div
                                    class="col-lg-12 col-md-9 col-12 py-2 saving_column inputesPaddingReport reportBtnInput">
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, item) {
                            $('.bg-secondary-subtle').append('<tr>' +
                                ...
                                '<td>' + item.purpose + '</td>' +
                                // '<td>' + item.guranter1 + '</td>' +
                                '</tr>');

                            grandTotal += parseFloat(item.loanAmount) || 0;
                        });
                        ...
                        //             '<td>' + row.purpose + '</td>' +
                        //             '<td>' + (row.guranter1AccountNo != null ? row
                        //                 .guranter1AccountNo + ' - ' + row.guranter1 +
                        //                 '<br>' : '') + (row.guranter2AccountNo != null ? row
                        //                 .guranter2AccountNo + ' - ' + row.guranter2 : '') +
                        //             '</td>' +
