        ...
        <div class="card-body py-2">
            <div class="row justify-content-between">
                <div class="col-lg-10 col-8 pe-0 misPrintMainHeading">
                    <h4 class="py-2"><span class="text-muted fw-light">Reports / Share List / </span> Print</h4>
                </div>
                <div class="col-lg-2 col-4 " style="display: flex; justify-content: flex-end; align-items: center;">
                    <!-- <button type="button" class="btn btn-primary btn-sm" style="float: right;" id="printButton" onclick="printReport()">Print</button> -->
                            ...
                            <table class="table text-center table-bordered">
                                <thead class="table_head verticleAlignCenterReport">
                                    <tr>
                                        ...
                                        <th scope="col" class="fw-bold">A/C No</th>
