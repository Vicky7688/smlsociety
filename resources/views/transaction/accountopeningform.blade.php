    ...
    <div class="card page_headings cards mb-4">
        <div class="card-body py-2">
            <div class="row justify-content-between">
                ...
                <div class="col-md-6 d-flex align-items-center  savingAccountHeading">
                    <small style="position: absolute;right: 196px;" >Name:</small>  <small style="position: absolute;right: 39px;" id="namehai"></small>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form action="javascript:void(0)" id="formData" name="formData">
                        ...
                        <div class="row row-gap-2">
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-3 saving_column inputesPadding">
                                ...
                                <input type="text" class="form-control formInputs transactionDate" placeholder="DD-MM-YYYY" id="transactionDate" name="transactionDate" value="{{ Session::get('currentdate') }}" />
                           ...
                           <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-3 saving_column inputesPadding">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                ...
                                <input type="text" class="form-control formInputs" id="membershipno" name="membershipno" placeholder="Membership No" autocomplete="off" />
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                ...
                                <select class="form-select formInputsSelect" id="accounttype" name="accounttype" onchange="getschemes(this.value)">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 d-none" id="fd-section">
                                ...
                                <select onchange="getschemeall(this.value)" name="fdType" id="fdType" class="select21 form-select form-select-sm Select" data-placeholder="Active">
                                    <option value="">Select</option>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                ...
                                <select class="form-select formInputsSelect" id="schemetype" name="schemetype"  onchange="getschemesamount(this.value)">
                                    <option value="">Select</option>
                                </select>
                            ...
                            <script>
                                function getschemesamount(id){
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                    ...
                                    <input type="text" class="form-control formInputs" id="roi" name="roi" placeholder="ROI" autocomplete="off" oninput="calculate()"   />
                                    <small class="text-danger error-roi"></small>
                                </div>

                         {{-- <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                <label for="amount" class="form-label">Amount</label>
                                <input type="text" class="form-control formInputs" id="amount" name="amount" placeholder="Amount" autocomplete="off" oninput="calculate()" />
                                <small class="text-danger error-amount"></small>
                            </div> --}}

                              {{--  <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                <label for="tanure" class="form-label">Tenure (Days) </label>
                                <input type="text" class="form-control formInputs" id="tanure" name="tanure" placeholder="Tenure" autocomplete="off"  oninput="calculate()"    />
                                <small class="text-danger error-tanure"></small>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                <label for="maturityamount" class="form-label">Maturity Amt.</label>
                                <input type="text" class="form-control formInputs" id="maturityamount" name="maturityamount" placeholder="Maturity Amt" autocomplete="off" />
                                <small class="text-danger error-maturityamount"></small>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                <label for="maturitydate" class="form-label">Maturity Date</label>
                                <input type="text" class="form-control formInputs" id="maturitydate" name="maturitydate" placeholder="Maturity Date" autocomplete="off" readonly />
                                <small class="text-danger error-maturitydate"></small>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                <label for="lockinperiod" class="form-label">Lockin Period (Days) </label>
                                <input type="text" class="form-control formInputs" id="lockinperiod" name="lockinperiod" placeholder="Lockin Period" autocomplete="off" oninput="getlockdate(this.value)" />
                                <small class="text-danger error-lockinperiod"></small>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-2 saving_column inputesPadding">
                                <label for="lockinperiod" class="form-label">Lockin Date</label>
                                <input type="text" class="form-control formInputs" id="lockindate" name="lockindate" placeholder="Lockin Date" autocomplete="off" readonly />
                                <small class="text-danger error-lockindate"></small>
                            </div> --}}
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-12 py-2 saving_column inputesPadding">
                                ...
                                <select class="form-select formInputsSelect" id="agentId" name="agentId">
                                    @if(!empty($agent_masters))
                                    <option value="">Select Agent</option>
                                    @foreach($agent_masters as $agent)
                                ...
                                <small class="text-danger error-agentId"></small>
                            </div>
                ...
                <form action="javascript:void(0)" id="modifiedFormData" name="modifiedFormData">
                    ...
                    <div class="row row-gap-3 justify-content-center">
                        ...
                        <div class="col-md-12 col-12 inputesPadding">
                            ...
                            <input type="text" readonly class="form-control formInputs" id="modifiedNarration" name="modifiedNarration" />
                            <small class="text-danger error"></p>
                        </div>
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                for (var field in response.errors) {
                    ...
                    alert(errormessages);
                    $('.error-' + field).text(response.errors[field][0]); // Display the first error message
                }
            }
        },
        error: function(xhr) {
