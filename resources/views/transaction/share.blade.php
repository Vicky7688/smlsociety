        ...
        <div class="card-body py-2">
            <div class="row justify-content-between">
                ...
                <div class="col-md-3 accountHolderDetails">
                    ...
                    <h6 class="pt-2 mb-0"><span class="text-muted fw-light">Share Balance: </span><span id="saving"></span>
                    </h6>
                </div>
            </div>
        </div>
                    ...
                    <form id="sharemember" action="{{route('shareupdate')}}" method="post">
                        ...
                        <div class="row row-gap-2">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-3  inputesPadding">
                                ...
                                <input id="transactionDate" type="text" name="transactionDate" class="form-control formInputs transactionDate" value="{{ Session::get('currentdate') }}" placeholder="Enter value" required />
                            </div>

                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-3  inputesPadding">
                                <label class="form-label mb-1" for="status-org">Action </label>
                                <select name="action" id="action" class="select21 form-select formInputsSelect" data-placeholder="Active" onchange="sharetrfdsaving('this')">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-3  inputesPadding">
                                ...
                                <input type="text" id="account" name="account" class="form-control formInputs" placeholder="Enter value" required />
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-3  inputesPadding">
                                <label for="txndate" class="form-label">Amount</label>
                                <input type="text" name="amount" class="form-control formInputs" placeholder="Enter value" required />
                            </div>
                            <!-- </div>
                        <div class="row"> -->
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-3  inputesPadding">
                                <label class="form-label mb-1" for="status-org">Agent </label>
                                <select name="agentId" id="status-org" class="select21 form-select formInputsSelect" data-placeholder="Active">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6 py-3 inputesPadding" id="accountdiv">
                                ...
                                <input type="text" name="saving_no" id="saving_no" class="form-control formInputs" placeholder="Enter value" />
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-6 py-3 inputesPadding">
                                <label for="txndate" class="form-label">Naration</label>
                                <input type="text" name="naration" class="form-control formInputs" placeholder="Enter value" />
                            </div>
                            <!-- </div> -->
                            <!-- <div class="row"> -->
            ...
            <form id="updateShare" action="{{route('shareupdate')}}" method="post">
                ...
                <div class="modal-body">
                    <div class="row row-gap-2">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <label class="form-label mb-1" for="status-org">Action </label>
                            <select name="action" id="action" class="select21 form-select formInputsSelect" data-placeholder="Active">
                    ...
                    <div class="row"> -->
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <label for="txndate" class="form-label">Naration</label>
                            <input type="text" name="naration" class="form-control formInputs" placeholder="Enter value" required />
                        </div>
                    </div>
                </div>
            ...
            success: function(data) {
                ...
                if (data.status == "success") {
                    ...
                    if (data.txndetails.length === 0) {} else {
                        ...
                        if(lastbal){
                            lastbal = (parseInt(lastbal) + parseInt(val.depositAmount) - parseInt(val.withdrawAmount));
                        }else{
                            lastbal = (parseInt(balanceAmount) + parseInt(val.depositAmount) - parseInt(val.withdrawAmount));
